		...
		return (
			<div className="informationDiv whiteText">
				...
				<p className="textLeft"><strong>Inside Book Club</strong> is an app designed for you and a few friends to enjoy the
					...
					are not provided.  Inside Book Club allows you access to only two clubs at a time per account.  One is
					...
					potentially cause other club members some unwanted feelings of abandonment due to the intimate nature 
					of the app...which is simply bad etiquette.  Please do not be the cause of their suffering.  If you are
					the "5 books per week" type, maybe signing up for multiple accounts would be the route for you.  
					Please join us!  Get your account set up and tell your friends to join in.  More instructions are on 
					the site when you sign up if needed.  Then, cozy up to the wonderful world of literature, and get started!
					Cheers!</p>
			</div>
		);	
	}
